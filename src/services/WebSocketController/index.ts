...
export class WebSocketController {
    ...
    public static parseClientMessage(
        ...
        try {
            ...
            if (
                parsed.type === MessageFileTypes.SEARCH &&
    ...
    public static async handleUserDisconnect(
        ...
        try {
            ...
            await this.broadcastUserStatusChange(
                username,
                false,
                webSocketServer
            );
            ...
            WebSocketController.sendingMessage(
                ...
                {
                    message:
                        'Server unexpected error while setting user offline',
                }
            );
        }
    }
    ...
    private static async sendAllUsers(clientSocket: WebSocket) {
        try {
            ...
            WebSocketController.sendingMessage(
                ...
                {
                    message:
                        'Server unexpected error while sending users statuses',
                }
            );
        }
    }
    ...
    public static async handleIncomingMessage(
        ...
        try {
            switch (parsed.type) {
                ...
                case MessageFileTypes.SEARCH:
                    await WebSocketController.searchMessage(
                        clientSocket,
                        webSocketServer,
                        parsed
                    );
                ...
                default:
                    ...
                    throw new Error(
                        `Unexpected message type: ${unexpectedType}`
                    );
            }
        } catch (error) {
            ...
            WebSocketController.sendingMessage(
                ...
                {
                    message:
                        'Server unexpected error during message processing',
                }
            );
        }
    }
    ...
    public static async searchMessage(
        ...
        try {
            ...
            const searchResult =
                await MessageHandlerService.handleSearchMessage(
                    parsed.query,
                    username
                );
            ...
            WebSocketController.sendingMessage(
                clientSocket,
                MessageFileTypes.SEARCH_RESULT,
                searchResult
            );
        } catch (error) {
